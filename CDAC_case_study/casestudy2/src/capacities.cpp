...
string capacities::getcapacity(){
	return capacity;
}
void capacities::setcapacity(string capacity){
	this->capacity=capacity;
}
string capacities::getfilled_capacity(){
	return filled_capacity;
}
void capacities::setfilled_capacity(string filled_capacity){
